...
export class CoreDateTime {
   ...
   */
  static formatFromSecond(timeStamp: number, formateString?: CoreDateTimeFormatter | string): string {
   ...
   * @param formateString [可选]格式化模板
   */
  static formatFromMilliSecond(timeStamp: number, formateString?: CoreDateTimeFormatter | string): string {
   ...
   * @param formateString [可选]格式化模板
   */
  static formatFromDate(date: Date | string, formateString?: CoreDateTimeFormatter | string): string {
    if (!formateString) {
      formateString = CoreConfig.dateTimeFormatter
    }
    switch (typeof date) {
      case 'string':
        date = new Date(date)
