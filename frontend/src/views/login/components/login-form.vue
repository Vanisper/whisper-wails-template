<template>
  <div class="login-form-wrapper">
    ...
    <a-divider :margin="20"><icon-star />调试区<icon-star /></a-divider>
    <a-row style="gap: 10px;align-items: center;">
      <span>是否使用后端菜单列表</span>
      <a-switch v-model="appStore.menuFromServer"></a-switch>
    </a-row>
  </div>
</template>
...
import type { LoginData } from '@/api/bak/user';
